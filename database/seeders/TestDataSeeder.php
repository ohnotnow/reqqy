    ...
    private function createFeatureRequestConversations(User $requestingUser, array $applications): void
    {
        ...
        $featureConversations = [
            [
                ...
                'summary' => 'User requested a bulk upload feature for demonstrator availability in the Demonstrator Scheduler. Coordinators currently receive HR spreadsheets but must manually enter each time slot. The feature should parse CSV files with staff IDs and time ranges, validate against known demonstrators, and detect scheduling conflicts before committing. A dry-run preview screen with conflict warnings is required for governance compliance.',
                'messages' => [
...
MARKDOWN,
            ...
            [
                ...
                'summary' => 'User requested a dedicated section for chemical storage limits in the Risk Assessment Tracker. Lab supervisors currently add this information to free-text notes fields. The feature should capture quantity limits and storage locations with structured data. The safety team requires automatic reminders when quantities exceed departmental thresholds to ensure compliance.',
                'messages' => [
            ...
            [
                ...
                'summary' => 'User requested automated reminder functionality for the Exam Moderator Portal to address external examiners missing deadlines. The system should support configurable reminder schedules that vary by qualification level (undergraduate vs postgraduate). Reminders must copy programme administrators and include an overdue dashboard so quality assurance teams can intervene on late submissions.',
                'messages' => [
...
MARKDOWN,
            ...
            [
                ...
                'summary' => 'User requested supervisor availability management in the Project Pairing Studio to prevent allocation conflicts when supervisors are on research leave. The system should allow supervisors to block out unavailable periods, warn administrators when student preferences conflict with availability windows, and generate a report of unallocated students grouped by topic area.',
                'messages' => [
...
MARKDOWN,
            ...
            [
                ...
                'summary' => 'User requested threshold-based alerting for VMStats to notify the infrastructure team when teaching clusters run above 90% CPU for more than 15 minutes. Email alerts should include affected host names and context. A weekly digest summarizing utilization trends is also required for capacity planning purposes.',
                'messages' => [
    ...
    private function createNewApplicationConversations(User $requestingUser): void
    {
        ...
        $newApplicationConversations = [
            [
                ...
                'summary' => 'User requested a new Industry Placement Hub to manage student placements with industry partners. The current spreadsheet-based process is causing placements to fall through. The system needs partner onboarding with compliance checks, student-employer matching, weekly progress monitoring, and risk alerts. Reporting dashboards are required for the Pro Vice-Chancellor to track cohort statistics.',
                'messages' => [
...
MARKDOWN,
            ...
            [
                ...
                'summary' => 'User explored the possibility of an AV equipment loan portal to replace the media team\'s current paper-based system. Items are frequently going missing. The system would need to support both student and staff authentication, handle loan requests with approval routing, provide automated reminders, and maintain comprehensive inventory tracking integrated with finance systems.',
                'messages' => [
            ...
            [
                ...
                'updated_at' => $now->copy()->subDays(3),
                'summary' => 'User requested a Digital Access Pass system to coordinate reasonable adjustments for students across departments. Staff need workflows to request, track, and fulfill adjustments with review date monitoring. Students should see a summary of their agreed support. The system must include alerts for overdue reviews and provide anonymized reporting for equality monitoring and compliance auditing.',
                'messages' => [
...
MARKDOWN,
            ...
            [
                ...
                'updated_at' => $now->copy()->subDay(),
                'summary' => 'User requested a Research Collaboration Atlas to catalogue cross-institution research partnerships and track funding deadlines. The system should store partner institutions, principal investigators, milestones, and integrate with Outlook calendars to keep academics informed of reporting deadlines. Document storage with faculty-based access control is required to give the legal team secure access to contracts.',
                'messages' => [
...
MARKDOWN,
            ...
            [
                ...
                'summary' => 'User requested an Apprenticeship Tracker to monitor placements, assessor visits, and endpoint assessment readiness for apprenticeship cohorts. The system needs to track learner progress, schedule assessor visits, capture employer feedback, and display funding milestones with alerts for overdue reviews. Integration with the reporting suite is required so the PVC Education can monitor completion rates for Ofsted compliance.',
                'messages' => [
...
MARKDOWN,
            ...
            [
                ...
                'created_at' => $now->copy()->subDays(7),
                'updated_at' => $now->copy()->subDays(3),
                'summary' => 'User requested a comprehensive Final Year Project Portal to replace spreadsheet-based dissertation management in Computer Science. Academics should post project proposals, students browse and submit their own proposals, and the system handles approval workflows and supervisor assignment. Industry projects require NDA and insurance tracking. The system should support optional GPA-based automated allocation for oversubscribed projects, progress milestone monitoring, and blind double marking with reconciliation workflows for assessment.',
                'messages' => [
