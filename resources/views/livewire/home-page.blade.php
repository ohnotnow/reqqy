<div class="max-w-4xl mx-auto py-12 px-4">
    ...
    <div class="grid md:grid-cols-2 gap-6">
            ...
            <flux:card class="hover:bg-zinc-100 dark:hover:bg-zinc-700 cursor-pointer h-full">
                <div class="text-center p-6">
                    <div class="rounded-full flex items-center justify-center mx-auto mb-4">
                        <flux:icon.puzzle-piece class="size-12" />
                    </div>
        ...
        <flux:card class="hover:bg-zinc-100 dark:hover:bg-zinc-700 cursor-pointer h-full" wire:click="startNewApplication">
            <div class="text-center p-6">
                <div class="rounded-full flex items-center justify-center mx-auto mb-4">
                    <flux:icon.sparkles class="size-12" />
                </div>
                <flux:heading size="xl" class="mb-3">
                    New Application
                </flux:heading>
